<?php
	...
	class PublicationPlace extends CI_Controller
	{
		...
		{
			$publicationPlaceInfo = $this->PublicationPlaceModel->MakeDataTables();
			$sl = 1;
			$data = array();
			...
			$output = array(
				...
				'recordsTotal' => $this->PublicationPlaceModel->GetAllData(),
				'recordsFiltered' => $this->PublicationPlaceModel->GetFilteredData(),
				'data' => $data
			);
