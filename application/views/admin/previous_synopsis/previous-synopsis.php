							...
							<form id="search-synopsis" class="form-horizontal">
								<div class="widget">
									<div class="widget-header">
										<i class="icon-tag"></i>
										<h3>Search Previous Synopsis</h3>
									</div>	<!-- /widget-header -->
									...
									<form id="news-reports-form" method="POST" action="<?= base_url('index.php/NewsReports/SearchNewsReports'); ?>">
										<table class="table table-striped table-bordered">
											...
											<tfoot>
												<tr>
													<td colspan="2">
														<button type="submit" id="button-news-reports" name="button-news-reports" class="btn btn-primary" onclick="return Validation()">Search Synopsis</button>
											...
											<tbody>
												<tr>
													<td>
														<input class="date-picker" type="text" id="from-date" name="from-date" placeholder="Select Date From" data-date-format="yyyy-mm-dd" style="width: 90%;">
													</td>

													<td>
														<input class="date-picker" type="text" id="to-date" name="to-date" placeholder="Select Date To" data-date-format="yyyy-mm-dd" style="width: 90%;">
													</td>
												</tr>
											</tbody>
										</table>
											...
											<tr>
												...
												<td>
													<div class="news-item-detail">
														<a href="create-synopsis-00.html" class="news-item-title" target="_blank">সমতায় শেষ হলো বাংলাদেশ-জিম্বাবুয়ে টেস্ট সিরিজ </a>
