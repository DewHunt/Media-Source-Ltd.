						...
						<div class="span9">
							<div class="widget">
								<div class="widget-header">
									...
									<a href="<?= base_url('index.php/SubBrand/Index'); ?>" type="submit" class="btn btn-primary">Sub Brand</a> 
								</div>
								<!-- /widget-header -->
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				var dataTable = $('#sub-brand-data').DataTable({
					...
					'order':[],
					'ajax':{
						url:'<?php echo base_url("index.php/SubBrand/GetDeletedSubBrandAllInfo"); ?>',
						type:'POST'
					},
					'dataType':'json',
					'columnDefs':[
				...
				$(document).on('click', '.retrieve', function(){
					...
					{
						$.ajax({
							url:'<?php echo base_url("index.php/SubBrand/RetrieveSubBrandData"); ?>',
							method:'POST',
