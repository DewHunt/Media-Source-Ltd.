						...
						<div class="span9">
							<div class="widget">
								<div class="widget-header">
									...
									<a href="<?= base_url('index.php/AdvertiseCategory/Index'); ?>" type="submit" class="btn btn-primary">Advertise Category</a> 
								</div>
								<!-- /widget-header -->
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				var dataTable = $('#advertise-category-data').DataTable({
					...
					'order':[],
					'ajax':{
						url:'<?php echo base_url('index.php/AdvertiseCategory/GetDeletedAdvertiseCategoryAllInfo'); ?>',
						type:'POST'
					},
					'dataType':'json',
					'columnDefs':[
				...
				$(document).on('click', '.retrieve', function(){
					...
					{
						$.ajax({
							url:'<?php echo base_url('index.php/AdvertiseCategory/RetrieveAdvertiseCategoryData'); ?>',
							method:'POST',
