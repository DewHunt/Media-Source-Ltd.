						...
						<div class="span9">
							<div class="widget">
								<div class="widget-header">
									...
									<a href="<?= base_url('index.php/AdvertiseInfo/Index'); ?>" type="submit" class="btn btn-primary">Adeverise Info</a> 
								</div>
								<!-- /widget-header -->
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				var dataTable = $('#advertise-info-data').DataTable({
					...
					'order':[],
					'ajax':{
						url:'<?php echo base_url("index.php/AdvertiseInfo/GetDeletedAdvertiseInfoAllInfo"); ?>',
						type:'POST'
					},
					'dataType':'json',
					'columnDefs':[
				...
				$(document).on('click', '.retrieve', function(){
					...
					{
						$.ajax({
							url:'<?php echo base_url('index.php/AdvertiseInfo/RetrieveAdvertiseInfoData'); ?>',
							method:'POST',
