						...
						<div class="span9">
							<div class="widget">
								<div class="widget-header">
									...
									<a href="<?= base_url('index.php/Page/Index'); ?>" type="submit" class="btn btn-primary">Page</a>
								</div>  <!-- /widget-header -->
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				var dataTable = $('#page-data').DataTable({
					...
					'order':[],
					'ajax':{
						url:'<?php echo base_url('index.php/Page/GetDeletedPageAllInfo'); ?>',
						type:'POST'
					},
					'dataType':'json',
					'columnDefs':[
				...
				$(document).on('click', '.retrieve', function(){
					...
					{
						$.ajax({
							url:'<?php echo base_url('index.php/Page/RetrievePageData'); ?>',
							method:'POST',
							data:{pageId:pageId},
